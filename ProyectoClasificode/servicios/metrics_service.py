...
class MetricsService:
    ...
    def update_kpi(self, name: str, value: float, context: Dict[str, Any] = None) -> bool:
        ...
        try:
            ...
            logging.debug(f"[METRICS] Métrica registrada: {name} = {value}")
            return True
            
        except Exception as e:
            logging.warning(f"[METRICS] Error registrando métrica {name}: {e}")
            return False
    ...
    def get_latest_kpis(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            ...
            logging.warning(f"[METRICS] Error obteniendo KPIs: {e}")
            return {}
    ...
    def get_metric_trend(self, metric_name: str, days: int = 7) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logging.warning(f"[METRICS] Error obteniendo tendencia de {metric_name}: {e}")
            return []
    ...
    def calculate_average_confidence(self, hours: int = 24) -> float:
        ...
        try:
            ...
            logging.warning(f"[METRICS] Error calculando confianza promedio: {e}")
            return 0.0
    ...
    def calculate_average_response_time(self, hours: int = 24) -> float:
        ...
        try:
            ...
            logging.warning(f"[METRICS] Error calculando tiempo promedio: {e}")
            return 0.0
    ...
    def get_feedback_ratio(self, hours: int = 24) -> float:
        ...
        try:
            ...
            logging.warning(f"[METRICS] Error calculando proporción de feedback: {e}")
            return 0.0
    ...
    def get_system_health_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'massive_test_summary': self.get_massive_test_summary()
            }
            
        except Exception as e:
            logging.warning(f"[METRICS] Error generando resumen de salud: {e}")
            return {
                ...
                'last_updated': datetime.utcnow().isoformat(),
                'recent_metrics': {},
                'massive_test_summary': None
            }
    
    def get_massive_test_summary(self) -> Optional[Dict[str, Any]]:
        """
        Lee el resumen generado por el script de prueba masiva si existe.
        No genera excepciones: cualquier error se registra y devuelve None.
        """
        ...
        try:
            ...
            logging.warning(f"[METRICS] No se pudo leer el reporte de test masivo: {exc}")
            return None
    
    def record_classification_metrics(self, case_id: int, confidence: float, 
                                     response_time: float, validation_score: float,
                                     requires_review: bool = False) -> None:
        """
        ...
        try:
            ...
            # Registrar evento de clasificación
            self.update_kpi('classification_event', confidence, {
                'case_id': case_id,
            ...
            # Registrar clasificación completada (compatibilidad histórica)
            ...
            logging.warning(f"[METRICS] Error registrando métricas de clasificación: {e}")
    ...
    def record_user_feedback(self, case_id: int, feedback_type: str) -> None:
        ...
        try:
            ...
            logging.warning(f"[METRICS] Error registrando feedback: {e}")
